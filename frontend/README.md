...
**Документ отражает текущее видение продукта и состояние репозитория.**  
При расхождении с кодом приоритет имеет версия в системе контроля версий после синхронизации README.
