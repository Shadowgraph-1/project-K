...
import type { BeganMotionCallback, FinishedMotionCallback } from '@framework/motion/acubismmotion';
  ...
  private setupModel(setting: ICubismModelSetting): void {
    ...
    const setupEyeBlink = (): void => {
      if (this._modelSetting.getEyeBlinkParameterCount() > 0) {
        ...
        const eyeBlinkUpdater = new CubismEyeBlinkUpdater(this._eyeBlink);
