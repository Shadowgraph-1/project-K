...
/** Linear-style field icon for the date submenu trigger */
export function TaskDateFieldIcon({ className }: IconProps) {
  return (
    <svg
      width="16"
      height="16"
...
export function TaskStartDateIcon({ className }: IconProps) {
  return (
    <CalendarArrowUp
      aria-hidden
      className={cn("shrink-0 text-muted-foreground", className)}
...
export function TaskDueDateIcon({ className }: IconProps) {
  return (
    <CalendarArrowDown
      aria-hidden
      className={cn("shrink-0 text-muted-foreground", className)}
