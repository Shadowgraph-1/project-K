...
// Live2D models are served from Vite's public directory.
...
export const ModelFileName: Record<string, string> = {
  NekoLilly: 'free1.model3.json',
  Kaguya: '八千代辉夜姬.model3.json'
};
